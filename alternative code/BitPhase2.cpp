...
//
//
//  Created by Adrian Vos on 06/06/2026.
//
...
// BitPhase.cpp
//
// Hybrid Phaser / Tremolo / Chaos Processor
...
public:
    virtual void ProcessSample() override
    {
        ...
        float phaserHz =
            0.05f + slowAmt * (6.0f - 0.05f);

        float tremHz =
            0.5f + rateNorm * (20.0f - 0.5f);
